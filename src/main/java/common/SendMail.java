...
public class SendMail {
	...
	public String myEmailAccount = "15115698431@163.com";
	public String myEmailPassword = "LQXZXZDAPAVRWESH";

	// 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般(只是一般, 绝非绝对)格式为: smtp.xxx.com
	// 网易163邮箱的 SMTP 服务器地址为: smtp.163.com QQ邮箱为smtp.qq.com 在各大邮箱的设置中能够找到。
	public String myEmailSMTPHost = "smtp.163.com"; 
	// 收件人邮箱（替换为自己知道的有效邮箱） // 1009105321@qq.com,wendy.wu@ibaiqiu.com,bella.wang@ibaiqiu.com,stephen.long@ibaiqiu.com,mike.liu@ibaiqiu.com,may.zhai@ibaiqiu.com
	public String receiveMailAccount = "stephen.long@ibaiqiu.com";  // 王书书<bella.wang@ibaiqiu.com>
	// 昵称,尽量设定，避免被识别为垃圾邮件
	public String nickname="IT系统质量部-"+SSHService.TesterName()+""; 
	// 抄送名单  mike.liu@ibaiqiu.com,15115698431@qq.com,stephen.long@ibaiqiu.com,stones.zhou@ibaiqiu.com
	public String copyMailAccount = "";  // sstones.zhou@ibaiqiu.com,stephen.long@ibaiqiu.com,wendy.wu@ibaiqiu.com
	// 标题
	public String title = "质量控制部-接口自动化测试工具缺陷提交与改进建议";
	// 属性
	...
	public void initMail() {
		...
		// QQ邮箱的SMTP(SLL)端口为465或587, 其他邮箱自行去查看)   163邮箱SMTP(SSL)端口号为465或994
