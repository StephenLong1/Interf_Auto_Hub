...
public class OrderCancel1 {
	...
	public void order_Cancel()   {
		try {
			body = "{\"DealCode\":\""+ deal_code +"\",\"shopCode\":\""+shopCode+"\",\"orderId\":\""+ SSHService.order_sn +"\",\"CancelReason\":\""+cancelReason+"\",\"Canceler\":\""+HttpClientKw.Encode(TesterName)+"\",\"CancelDate\":\""+SSHService.NowTime+"\"}";
