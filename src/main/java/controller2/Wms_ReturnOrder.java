...
public class Wms_ReturnOrder {
     ...
     */
    @Test(description = "OMS推送退货单到对接平台", priority = 0, enabled = true)
    public void return_To_Hub() {
        try {
            body = "{\"returnOrder\":{\"returnOrderCode\":\"" + SSHService.return_sn() + "\",\"warehouseCode\":\"BQJX01\",\"orderType\":\"THRK\",\"preDeliveryOrderCode\":\"" + SSHService.order_sn() + "\",\"logisticsCode\":\"SF\",\"logisticsName\":\"SF\",\"expressCode\":\"12345678\",\"buyerNick\":\""+SSHService.TesterName()+"\",\"senderInfo\":{\"name\":\""+SSHService.TesterName()+"\",\"mobile\":\"13100000000\",\"email\":\"\",\"province\":\"\\u4e0a\\u6d77\\u000d\\u000a\",\"city\":\"\\u4e0a\\u6d77\\u000d\\u000a\",\"area\":\"\\u4e0a\\u6d77\\u000d\\u000a\",\"detailAddress\":\"\\u4e0a\\u6d77\\u5e02\\u957f\\u5b81\\u533a\\u63a5\\u53e3\\u81ea\\u52a8\\u5316\"},\"remark\":\"\",\"returnReason\":\""+SSHService.returnReason()+"\"},\"orderLines\":{\"orderLine\":[{\"orderLineNo\":" + SSHService.order_return_goods_id() + ",\"sourceOrderCode\":\"" + SSHService.deal_code() + "\",\"subSourceOrderCode\":\"" + SSHService.oid1() + "\",\"ownerCode\":\"" + ownerCode + "\",\"itemCode\":\"" + goods_barcode1 + "\",\"planQty\":" + goods_number1 + ",\"snList\":{\"sn\":[]},\"inventoryType\":\"ZP\",\"extendProps\":{\"preOrderId\":\"\",\"preSubOrderId\":\"" + SSHService.outer_order_id + "\",\"barCode\":\"" + goods_barcode1 + "\",\"UnitPrice\":\"" + goods_price1 + ".00\"}}]},\"extendProps\":{\"shopCode\":\"" + shopCode + "\",\"ReceiptAmount\":\"" + ssh.totalPrice1 + "\",\"Zip\":\"000000\"}}";
	        ...
	        HttpClientKw.doGet("点击推送仓库/退货单","http://39.98.231.61:30003/admin/return/pushwms?","returns="+SSHService.return_id()+"&is_push=1",HttpClientKw.token,HttpClientKw.X_CSRF_TOKEN,"","");
