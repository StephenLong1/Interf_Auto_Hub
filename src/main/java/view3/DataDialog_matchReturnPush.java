...
import view4.RunDialog_returnMatchPush;
...
public class DataDialog_matchReturnPush extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DataDialog_matchReturnPush dialog = new DataDialog_matchReturnPush();
	 ...
	 * Create the dialog.
	 */
	public DataDialog_matchReturnPush() {
		setTitle("平台订单号");
		setBounds(100, 100, 372, 190);
		setResizable(false);
		...
		textField_deal_code.setBounds(156, 31, 181, 24);
		...
		lblNewLabel_2.setBounds(34, 31, 104, 24);
		...
		btnNewButton_save.setBounds(61, 92, 77, 30);
		...
		btnNewButton_getProperties.setBounds(220, 92, 77, 30);
...
//			new RunDialog_delivery1().setVisible(true);
			new RunDialog_returnMatchPush().setVisible(true);
		}
	}
