...
import view4.RunDialog_wms_entryOrderConfirm;
...
public class DataDialog_wms_entryOrderConfirm extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DataDialog_wms_entryOrderConfirm dialog = new DataDialog_wms_entryOrderConfirm();
	 ...
	 * Create the dialog.
	 */
	public DataDialog_wms_entryOrderConfirm() {
		setTitle("填写订单号");
...
//			new RunDialog_delivery1().setVisible(true);
			new RunDialog_wms_entryOrderConfirm().setVisible(true);
