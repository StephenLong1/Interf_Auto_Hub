...
import view4.RunDialog_orderCancel2;

import javax.swing.JLabel;
import java.awt.event.ActionListener;
import java.awt.event.ActionEvent;

public class ChoiceDialog_orderCancel extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ChoiceDialog_orderCancel dialog = new ChoiceDialog_orderCancel();
	 ...
	 * Create the dialog.
	 */
	public ChoiceDialog_orderCancel() {
		setTitle("订单类型选择框");
		...
		}
		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					dispose();
					new RunDialog_orderCancel2().setVisible(true);
				}
			});
