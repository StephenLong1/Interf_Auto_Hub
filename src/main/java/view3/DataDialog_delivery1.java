...
public class DataDialog_delivery1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DataDialog_delivery1 dialog = new DataDialog_delivery1();
...
//			new RunDialog_delivery1().setVisible(true);
			new ChoiceDialog_delivery().setVisible(true);
