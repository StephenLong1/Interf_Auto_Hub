...
public class ChoiceDialog_wms_delivery extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ChoiceDialog_wms_delivery dialog = new ChoiceDialog_wms_delivery();
	 ...
	 * Create the dialog.
	 */
	public ChoiceDialog_wms_delivery() {
		...
		contentPanel.setLayout(null);
		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					dispose();
					new RunDialog_wms_deliveryOrder1().setVisible(true);
				}
			});
