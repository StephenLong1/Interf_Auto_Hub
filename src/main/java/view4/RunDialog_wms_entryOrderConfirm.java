...
public class RunDialog_wms_entryOrderConfirm extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_wms_entryOrderConfirm dialog = new RunDialog_wms_entryOrderConfirm();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_wms_entryOrderConfirm() {
		setTitle("控制台：测试WMS采购入仓单回写<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Wms_EntryOrderConfirm.class});
					testSuite.run();
		...
		lblNewLabel.setBounds(273, 10, 348, 37);
