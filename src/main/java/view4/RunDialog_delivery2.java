...
import controller.DeliveryOrder2;
...
public class RunDialog_delivery2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_delivery2 dialog = new RunDialog_delivery2();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_delivery2() {
		setTitle("控制台：测试通知发货接口<多订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {DeliveryOrder2.class});
					testSuite.run();
