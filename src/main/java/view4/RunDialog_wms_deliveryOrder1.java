...
import controller2.Wms_DeliveryOrder;
...
public class RunDialog_wms_deliveryOrder1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_wms_deliveryOrder1 dialog = new RunDialog_wms_deliveryOrder1();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_wms_deliveryOrder1() {
		setTitle("控制台：测试wms通知发货接口<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Wms_DeliveryOrder.class});
					testSuite.run();
