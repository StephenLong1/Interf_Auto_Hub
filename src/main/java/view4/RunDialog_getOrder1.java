...
import controller.OrderCreate1;
...
public class RunDialog_getOrder1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_getOrder1 dialog = new RunDialog_getOrder1();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_getOrder1() {
		setTitle("生成已审核的天猫销售单【一个oid】");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {OrderCreate1.class});
					testSuite.run();
		...
		btnNewButton_1.setBounds(147, 10, 93, 37);
