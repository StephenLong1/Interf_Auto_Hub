...
import controller2.Return_Match_Data;
...
public class RunDialog_returnMatchPush extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnMatchPush dialog = new RunDialog_returnMatchPush();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_returnMatchPush() {
		setTitle("控制台：退货匹配完成后推送<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Return_Match_Data.class});
					testSuite.run();
