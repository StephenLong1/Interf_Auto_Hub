...
public class RunDialog_deliveryBack extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_deliveryBack dialog = new RunDialog_deliveryBack();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_deliveryBack() {
		setTitle("控制台：测试发货回传接口");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {DeliveryBack.class});
					testSuite.run();
