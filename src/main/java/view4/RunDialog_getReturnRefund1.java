...
public class RunDialog_getReturnRefund1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_getReturnRefund1 dialog = new RunDialog_getReturnRefund1();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_getReturnRefund1() {
		setTitle("生成天猫退货退款单<oid1>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnCreate1.class});
					testSuite.run();
