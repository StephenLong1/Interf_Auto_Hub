...
public class RunDialog_shippingData extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_shippingData dialog = new RunDialog_shippingData();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_shippingData() {
		setTitle("控制台：发货数据推送<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Sales_Shipping_Data.class});
					testSuite.run();
