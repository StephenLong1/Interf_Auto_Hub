...
public class RunDialog_wms_returnOrderConfirm extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_wms_returnOrderConfirm dialog = new RunDialog_wms_returnOrderConfirm();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_wms_returnOrderConfirm() {
		setTitle("控制台：测试WMS退货入库回传接口<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Wms_ReturnOrderConfirm.class});
					testSuite.run();
		...
		lblNewLabel.setBounds(269, 10, 348, 37);
