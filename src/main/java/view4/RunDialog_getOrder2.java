...
import controller.OrderCreate2;
...
public class RunDialog_getOrder2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_getOrder2 dialog = new RunDialog_getOrder2();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_getOrder2() {
		setTitle("生成已审核的天猫销售单【多个oid】");
		...
		setAlwaysOnTop(true);
		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {OrderCreate2.class});
					testSuite.run();
