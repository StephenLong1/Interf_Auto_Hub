...
import controller2.Return_Finish_Data;
import controller2.Sales_Shipping_Data;
...
public class RunDialog_returnFinishPush extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnFinishPush dialog = new RunDialog_returnFinishPush();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_returnFinishPush() {
		setTitle("控制台：退货退款完成后推送<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Return_Finish_Data.class});
					testSuite.run();
