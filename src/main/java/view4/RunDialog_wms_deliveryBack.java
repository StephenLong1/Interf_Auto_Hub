...
public class RunDialog_wms_deliveryBack extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_wms_deliveryBack dialog = new RunDialog_wms_deliveryBack();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_wms_deliveryBack() {
		setTitle("控制台：测试WMS发货回传接口<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Wms_DeliveryBack.class});
					testSuite.run();
		...
		lblNewLabel.setBounds(281, 11, 348, 37);
