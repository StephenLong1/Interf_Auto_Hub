...
import controller.DeliveryBack;
import controller.RefundBack;
...
public class RunDialog_refundBack extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_refundBack dialog = new RunDialog_refundBack();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_refundBack() {
		setTitle("控制台：测试退款确认回传接口");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {RefundBack.class});
					testSuite.run();
