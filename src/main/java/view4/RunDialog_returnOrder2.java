...
import controller.ReturnOrder2;
...
public class RunDialog_returnOrder2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnOrder2 dialog = new RunDialog_returnOrder2();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_returnOrder2() {
		setTitle("控制台：测试推送退货单接口<多订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnOrder2.class});
					testSuite.run();
