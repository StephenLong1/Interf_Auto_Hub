...
import controller.ReturnCreate1;
import controller.ReturnCreate2;
...
public class RunDialog_getReturnRefund2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_getReturnRefund2 dialog = new RunDialog_getReturnRefund2();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_getReturnRefund2() {
		setTitle("生成天猫退货退款单<oid2>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnCreate2.class});
					testSuite.run();
