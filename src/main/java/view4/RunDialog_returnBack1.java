...
public class RunDialog_returnBack1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnBack1 dialog = new RunDialog_returnBack1();
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnBack1.class});
					testSuite.run();
