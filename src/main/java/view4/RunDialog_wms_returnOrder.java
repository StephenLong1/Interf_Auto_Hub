...
import controller.ReturnOrder1;
import controller2.Wms_ReturnOrder;
...
public class RunDialog_wms_returnOrder extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_wms_returnOrder dialog = new RunDialog_wms_returnOrder();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_wms_returnOrder() {
		setTitle("控制台：测试推送退货单接口<单订单>");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {Wms_ReturnOrder.class});
					testSuite.run();
