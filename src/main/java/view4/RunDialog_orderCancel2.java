...
import controller.OrderCancel2;
...
public class RunDialog_orderCancel2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_orderCancel2 dialog = new RunDialog_orderCancel2();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_orderCancel2() {
		setTitle("控制台：测试订单取消接口【多订单】");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {OrderCancel2.class});
					testSuite.run();
