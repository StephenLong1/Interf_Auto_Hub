...
public class RunDialog_returnOrder1 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnOrder1 dialog = new RunDialog_returnOrder1();
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnOrder1.class});
					testSuite.run();
