...
import controller.ReturnRemove;
...
public class RunDialog_returnRemove extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnRemove dialog = new RunDialog_returnRemove();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_returnRemove() {
		setTitle("控制台：测试退货单作废接口");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnRemove.class});
					testSuite.run();
