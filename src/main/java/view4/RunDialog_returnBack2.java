...
public class RunDialog_returnBack2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			RunDialog_returnBack2 dialog = new RunDialog_returnBack2();
	 ...
	 * Create the dialog.
	 */
	public RunDialog_returnBack2() {
		setTitle("控制台：测试退货入库回传接口");
...

		{
			...
			btnNewButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					testSuite.setTestClasses(new Class[] {ReturnBack2.class});
					testSuite.run();
